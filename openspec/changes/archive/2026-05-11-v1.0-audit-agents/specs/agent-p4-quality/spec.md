...
(Previously: P4 quality.md already contains basic CVE methodology at lines 112-123. This expansion adds multi-source advisory lookup and usage-scoped severity triage.)
