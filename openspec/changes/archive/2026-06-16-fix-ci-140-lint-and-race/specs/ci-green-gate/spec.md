# Delta for ci-green-gate

## ADDED Requirements

`ci-green-gate` is NEW. All 8 requirements MUST hold for the CI green-bar gate across the 5-platform CI matrix. Change is authored from commit `20f352d` (CI #140 failing baseline).
