...
- [ ] At least 1 reviewer approval required before workflow executes
- [ ] Documented: who can approve releases, how to request approval
- [ ] Tested: tag push triggers approval request, not immediate execution
...
**Priority Order**: P6-001 + P6-002 (CRITICAL, immediate) → P6-005 (quick gate) → P6-003 + P6-004 + P6-006 (CORR-001 batch) → P6-008 + P6-009 + P6-011 → P6-013 + P6-014 → P6-010 → P6-007 (backlog)
