...
/sequoia diff
  ...
  │     ├─ Solo hallazgos críticos y de riesgo (no es auditoría completa)
  │     └─ Listar como "nuevos"
  │
...
|------|---------------|--------------|-----------|
| Security | | | Mejorando / Estable / Degradando |
| Performance | | | Mejorando / Estable / Degradando |
| ... | | | |
...
> La última auditoría tiene {N} días. Los hallazgos pueden estar desactualizados. Considerá ejecutar `/sequoia audit` para una auditoría fresca.
