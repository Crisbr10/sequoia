...
//
// Templates are read and parsed on every call — embedded filesystem reads
// are fast and avoiding a global cache eliminates cross-platform pointer
// identity issues with embed.FS across Go versions.
